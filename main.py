...
def level2(event):
    ...
    canvas.create_image(100, 200, image=obt2, anchor=NW, tags="wall")
    canvas.create_image(940, 330, image=obt2, anchor=NW, tags="wall")

    obt3 = PhotoImage(file="OBT3.png")
    canvas.create_image(630, 200, image=obt3, anchor=NW, tags="wall")
    canvas.create_image(1100, 200, image=obt3, anchor=NW, tags="wall")
    canvas.create_image(260, 400, image=obt3, anchor=NW, tags="wall")

    flies = PhotoImage(file='OBT4.png')
